          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center space-x-1">
              ...
              >
                ...
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 mt-2 w-[800px] bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transition-all duration-500 ${
                    isProductsOpen
