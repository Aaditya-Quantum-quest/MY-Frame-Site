...
export default function FrameEditor() {
  ...
  return (
    <div className="py-30 bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl md:text-5xl font-medium text-center text-gray-900 mb-6">
          Acrylic Wall Photo Editor <br /> ({widthCm}×{heightCm}cm)
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-80 bg-white rounded-md shadow-md p-6 space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-2">Frame Shape</label>
              <select
                ...
                className="w-full border-2 border-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium text-black cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white hover:border-gray-400 transition-colors"
              >
            ...
            {/* Frame Color */}
            <div>
              <label className="block text-sm font-medium mb-2 text-black ">Outer Frame Color</label>
            ...
            {/* Mat Color */}
            <div>
              <label className="block text-sm font-medium text-black mb-2">Inner Frame Color</label>
              <div className="flex gap-2 flex-wrap">
            ...
            {/* Frame Thickness - ONLY THIS SLIDER REMAINS */}
            <div>
              <label className="block text-sm font-medium bg-blakc mb-1">
