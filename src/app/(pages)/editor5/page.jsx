...
export default function PhotoFrameEditor() {
  ...
  const handleSave = () => {
    ...
    if (isCircle) {
      ...
      ctx.moveTo(radius, 0);
      ctx.lineTo(frameWidth - radius, 0);
      ctx.quadraticCurveTo(frameWidth, 0, frameWidth, radius);
      ctx.lineTo(frameWidth, frameHeight - radius);
      ctx.quadraticCurveTo(frameWidth, frameHeight, frameWidth - radius, frameHeight);
      ctx.lineTo(radius, frameHeight);
      ctx.quadraticCurveTo(0, frameHeight, 0, frameHeight - radius);
      ctx.lineTo(0, radius);
  ...
  const renderImageArea = () => (
    <div
      className="w-full h-full bg-gray-200 relative overflow-hidden transition-all duration-300"
      style={{ borderRadius }}
      ...
      {!image ? (
        <div className="absolute inset-0 flex items-center justify-center">
          <Button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 rounded-xl font-bold text-lg shadow-lg transition-all hover:scale-105"
          >
  ...
  const renderDualFrame = () => (
    <div
      className="w-full h-full bg-white overflow-hidden transition-all duration-300"
      style={{
    ...
    >
      <div
        className="w-full h-full bg-black overflow-hidden transition-all duration-300"
        style={{
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 mb-6">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select
                value={frameShape}
                onValueChange={(value) => setFrameShape(value)}
              >
            ...
            <div className="flex items-center gap-2">
              <label className="text-sm font-medium text-gray-900">Frame:</label>
        ...
        <div className="bg-white rounded-xl shadow-md p-8 mb-6">
          <div className="flex items-center justify-center">
            <div
              className="shadow-lg transition-all duration-300 overflow-hidden"
              style={{
                width: `${frameWidth}px`,
        ...
        <Button
          onClick={handleSave}
          disabled={!image}
          className="w-full py-6 text-lg font-bold bg-blue-600 hover:bg-blue-700 text-white disabled:bg-gray-300 disabled:text-gray-500 transition-all"
          size="lg"
        >
